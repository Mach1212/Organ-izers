...
public class Drone {
    ...
    /**
     * Emulates a drone that would still be on the pad
     * @param name Drone's name
     * @param latitude The drone's latitude
     * @param longitude The drone's longitude
     */
     ...
     */
    public Drone(String name, double latitude, double longitude, double destLatitude, double destLongitude, int[4] payload) {
        this.name = name;
     ...
     * @return if the drone has reached it's destination
     */
